      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-fadeInUp">
          ...
          <div className="space-y-6">
            <p className="text-blue-600 uppercase text-sm font-semibold tracking-wider animate-fadeInLeft">
              Bạn muốn trở thành thành viên cộng đồng?
            </p>
          ...
          <div className="flex lg:justify-end animate-fadeInRight">
            <Button className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white px-10 py-7 text-xl shadow-xl hover:shadow-blue-500/40 transform hover:scale-105 transition-all duration-300">
              Đăng Ký Ngay
        ...
        <div className="mt-20 border-t border-blue-100 pt-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl hover:bg-blue-50 transition-all duration-300 hover-lift animate-fadeInUp delay-100">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <Phone className="w-6 h-6 text-blue-600" />
              </div>
              <p className="text-blue-600 text-sm mb-2">Điện Thoại</p>
              <p className="text-blue-900 font-bold text-lg">+(747) 333-8772</p>
            </div>
            <div className="text-center p-6 rounded-xl hover:bg-blue-50 transition-all duration-300 hover-lift animate-fadeInUp delay-200">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <MapPin className="w-6 h-6 text-blue-600" />
              </div>
              <p className="text-blue-600 text-sm mb-2">Địa Chỉ</p>
              <p className="text-blue-900 font-bold">7300 TOPANGA CANYON #6, CA 91303</p>
            </div>
            <div className="text-center p-6 rounded-xl hover:bg-blue-50 transition-all duration-300 animate-fadeInUp delay-300">
