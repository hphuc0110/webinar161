...
export default function Speaker() {
  ...
  const speakers = {
    hung: {
      ...
      bio: `Admin cộng đồng Bình dân học AI
Chia sẻ và trình diễn trực tiếp cách AI được ứng dụng để triển khai nhanh các công việc Marketing, từ lập kế hoạch đến xây dựng tài liệu chiến dịch.`,
